...
public class Main {
    public static void main(String[] args) {
        ...
        Usuario aspirante = controlador.createUser("1", "Andres", "1234");
        // Verificacion Login
        ...
        // Creacion oferta
            ...
            System.out.println(AESEncript.decrypt(controlador.action(AESEncript.encrypt("6/"+key2+"/1/2/Muchas cosas wuu!!"))));
        ...
        // Imprimir Ofertas
        System.out.println(AESEncript.decrypt(controlador.action(AESEncript.encrypt("9/"+key2+"/123524"))));
